...
class MCMC:
    ...
    def create_anneal_schedule(self):
        ...
        while curr_sweep < self.total_sweeps:
            ...
            temp_list.extend(np.linspace(curr_temp, 0.10, 2).tolist())
            curr_sweep += 2
            temp_list.extend(np.linspace(0.10, 0.08, 2).tolist())
            curr_sweep += 2
            temp_list.extend(np.repeat(0.08, 2).tolist())
            curr_sweep += 2
            temp_list.extend(np.linspace(0.08, curr_temp, 2).tolist())
